...
<div class="main-content">
    ...
    <div class="employee-card">
        ...
        <div class="alert alert-warning">
            ...
            <strong>Cảnh báo:</strong> Bạn đang sắp xóa đơn nghỉ phép của nhân viên <strong><?= $row['full_name'] ?></strong> từ <strong><?= $row['start_date'] ?></strong> đến <strong><?= $row['end_date'] ?></strong>. Hành động này không thể hoàn tác!
        </div>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p><strong>Loại:</strong> <?= $row['leave_type'] ?></p>
                <p><strong>Từ ngày:</strong> <?= $row['start_date'] ?></p>
                <p><strong>Đến ngày:</strong> <?= $row['end_date'] ?></p>
                <p><strong>Lý do:</strong> <?= $row['reason'] ?></p>
                ...
                <p><strong>Người duyệt:</strong> <?= $row['approved_by_name'] ?? 'Chưa có' ?></p>
            </div>
        </div>

        <form method="POST"
            action="/hrm-system/public/index.php?controller=Leave&action=destroy">
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                ...
                <button type="submit"
                    ...
                    onclick="return confirm('Bạn có chắc chắn muốn xóa đơn nghỉ phép này?');">
                    <i class="fa-solid fa-trash"></i>
                    Xác nhận xóa
                </button>
