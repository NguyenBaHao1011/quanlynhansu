...
<div class="main-content">
    ...
    <div class="employee-card">
        ...
        <form method="POST"
            action="/hrm-system/public/index.php?controller=Department&action=update">
                    ...
                    <select name="manager_id"
                        ...
                        <?php if(isset($employees) && $employees->num_rows > 0): ?>
                            <?php while($emp = $employees->fetch_assoc()): ?>
                                <option value="<?= $emp['id'] ?>" <?= $row['manager_id'] == $emp['id'] ? 'selected' : '' ?>><?= $emp['employee_code'] ?> - <?= $emp['full_name'] ?></option>
                            <?php endwhile; ?>
                        <?php endif; ?>
                    </select>
