...
<div class="main-content">
    ...
    <div class="employee-card">
        ...
        <form method="POST"
            action="/hrm-system/public/index.php?controller=Contract&action=update">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="contract_type"
                        class="form-control"
                        required>
                        <option value="Probation" <?= $row['contract_type'] == 'Probation' ? 'selected' : '' ?>>Thử việc</option>
                        <option value="Official" <?= $row['contract_type'] == 'Official' ? 'selected' : '' ?>>Chính thức</option>
                        <option value="Seasonal" <?= $row['contract_type'] == 'Seasonal' ? 'selected' : '' ?>>Theo mùa vụ</option>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select name="status"
                        class="form-control">
                        <option value="Active" <?= $row['status'] == 'Active' ? 'selected' : '' ?>>Đang hiệu lực</option>
                        <option value="Expired" <?= $row['status'] == 'Expired' ? 'selected' : '' ?>>Hết hạn</option>
                        <option value="Terminated" <?= $row['status'] == 'Terminated' ? 'selected' : '' ?>>Đã chấm dứt</option>
                    </select>
