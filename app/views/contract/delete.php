...
<div class="main-content">
    ...
    <div class="employee-card">
        ...
        <div class="alert alert-warning">
            ...
            <strong>Cảnh báo:</strong> Bạn đang sắp xóa hợp đồng <strong><?= $row['contract_code'] ?></strong> của nhân viên <strong><?= $row['full_name'] ?></strong>. Hành động này không thể hoàn tác!
        </div>

        <div class="card mb-4">
            <div class="card-body">
                <h5 class="card-title">Thông tin hợp đồng</h5>
                <p><strong>Mã HĐ:</strong> <?= $row['contract_code'] ?></p>
                <p><strong>Nhân viên:</strong> <?= $row['employee_code'] ?> - <?= $row['full_name'] ?></p>
                <p><strong>Loại HĐ:</strong> <?= $row['contract_type'] ?></p>
        ...
        <form method="POST"
            action="/hrm-system/public/index.php?controller=Contract&action=destroy">
